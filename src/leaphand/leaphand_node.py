...
class LeapNode:
    def __init__(self):
        ...
        self.joint_state_pub = rospy.Publisher('/j2n6s300_driver/out/joint_state', JointState, queue_size=10)
    ...
    def publish_joint_states(self, event):
        ...
        msg.name = ["{}".format(i) for i in range(16)]
        msg.position = self.dxl_client.read_pos() - math.pi
        msg.velocity = self.dxl_client.read_vel()
        msg.effort = self.dxl_client.read_cur()
