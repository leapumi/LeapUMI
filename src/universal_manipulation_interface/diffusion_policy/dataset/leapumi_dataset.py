...
class LeapUmiDataset(BaseDataset):
    def __init__(self,
        shape_meta: dict,
        dataset_path: str,
    ...
    def get_normalizer(self, **kwargs) -> LinearNormalizer:
        ...
        for i in range(self.num_robot):
            ...
            action_normalizers.append(get_identity_normalizer_from_stat(array_to_stats(data_cache['action'][..., i * dim_a + 3: (i + 1) * dim_a - 16]))) # rot
            action_normalizers.append(get_range_normalizer_from_stat(array_to_stats(data_cache['action'][..., (i + 1) * dim_a - 16: (i + 1) * dim_a])))  # gripper
    ...
    def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
        ...
        # print("shape meta obs keys", self.shape_meta['obs'].keys())
        ...
        for robot_id in range(self.num_robot):
            ...
            action_mat = pose_to_mat(data['action'][...,22 * robot_id: 22 * robot_id + 6])
            ...
            action_gripper = data['action'][..., 22 * robot_id + 6: 22 * robot_id + 22]
